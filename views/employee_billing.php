    ...
    <table id="main_layout">
        <tr>
            <td id="sidebar">
                ...
                <a href="../controllers/employee_billing_controller.php" id="active_menu">BILLING</a>
                    ...
                    <tr>
                        <td valign="top" width="65%" style="padding-right: 15px;">
                            <fieldset>
                                ...
                                <form method="POST" action="../controllers/employee_billing_controller.php" id="addItemForm" onsubmit="return validateAddItem();">
                        ...
                        <td valign="top" width="35%">
                            ...
                            <table id="actions_table">
                                <tr>
                                    <td>
                                        <form method="POST" action="../controllers/employee_billing_controller.php">
    ...
    <script>
        function confirmLogout() {
            if (confirm("Are you sure you want to log out?")) {
                window.location.href = "../controllers/employee_billing_controller.php?action=logout";
            }
        }
